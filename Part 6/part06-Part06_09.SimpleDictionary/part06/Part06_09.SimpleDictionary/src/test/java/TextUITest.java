...
public class TextUITest<_SimpleDictionary> {
    ...
    String klassName = "JokeManager.java";
    ...
    public void setUp() {
        ...
        try {
            textUIClass = ReflectionUtils.findClass("JokeManager.java");
    ...
    public void constructor() throws Throwable {
        ...
        String e = "the error was caused by the code new JokeManager.java(new Scanner(System.in), new SimpleDictionary());";
    ...
    public void startMethod() throws Throwable {
        ...
        String v = "\nThe error was caused by the following code\n "
                + "JokeManager.java t = new JokeManager.java(new Scanner(System.in), new SimpleDictionary());\n"
                + "t.start();";
